...
// */
//public class FullscreenActivity_bkp extends AppCompatActivity {
//    /**
...
////        fl.setBackgroundResource(R.drawable.wall2);
...
////        fl.setBackground(new BitmapDrawable(getResources(), wp));
//        iv.setImageBitmap(wp);
////        System.out.println("The background: "+iv.getBackground());
////        fl.setScaleX();
//    }
//
//    @Override
